...
<form class="navbar-form navbar-left" role="form" action="<?php bloginfo('siteurl'); ?>/" id="searchform" method="get">
    ...
    <div class="input-group">
        <input type="text" class="form-control" id="s" name="s" placeholder="Search" value=<?php echo $_GET["s"]; ?>>
	<?php if ($category !== '') { echo sprintf('<input type="hidden" name="category_name" value="%s" />', $category); } ?>
